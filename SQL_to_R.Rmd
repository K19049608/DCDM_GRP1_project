...
DCDM_project <- dbConnect(RMySQL::MySQL(), dbname = 'database1', username = 'your_username', password = 'your_password')

#list all tables in the database
dbListTables(DCDM_project)
#list all fields/columns in a table in the database
dbListFields(DCDM_project, "group_list")

#query the database and store the output as a dataframe
analysis_data = dbGetQuery(DCDM_project, "SELECT parameter_group from parameter")
